  ...
  return (
    <div className="flex/ h-screen    ">
      ...
      <button
        ...
        bottom-10 right-4 xxs:bottom-4    absolute z-50 rounded-full p-4 bg-spotifyGreen transform transition duration-200 ease-in  `}
      >
      ...
      <TrashIcon
        ...
        } bottom-10 xxs:bottom-7    h-8 w-8 absolute cursor-pointer z-30  ml-4 text-white transform transition duration-200 ease-in hover:scale-105`}
      />
      <Tooltip
