...
function Sidebar() {
  ...
  return (
    <nav className="sticky// fixed     w-full xxs:sticky xxs:w-auto         z-[60] bottom-0 ModalInterfere:-> xxs:z-0     flex xxs:flex-col xxs:h-screen py-3 xxs:py-0   border-t-2 xxs:border-t-0      bg-spotifyBlack items-center xxs:pt-4 xxs:border-r border-gray-600 ">
